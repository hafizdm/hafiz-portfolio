...
>
  <div className="relative min-h-[calc(100vh-88px)]">
    ...
    {/* ================= LEFT CONTENT ================= */}
    <div className="mx-auto grid min-h-[calc(100vh-88px)] max-w-7xl lg:grid-cols-2">

      <div className="flex items-center px-6 py-16 md:px-10 lg:py-20">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 md:py-20">
          ...
          <div className="grid gap-14 md:grid-cols-2 md:items-center">
            ...
            <div className="flex justify-center md:justify-start">
              ...
              <div className="relative h-[460px] w-full max-w-[420px] overflow-hidden rounded-[2.5rem] bg-gray-200 sm:h-[540px]">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 md:py-20">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-gray-600 md:text-lg">
              I provide practical technology solutions to support business
              operations, improve internal processes, and solve day-to-day
              technical challenges. From IT support and system analysis to
              process automation and application development, I focus on
              creating reliable solutions that make work simpler and more
              efficient.
            </p>
